<?php
	...
	$pdf->Image('../resources/images/logo-removed.png',165,12,35,35,'PNG');
	...
	$pdf->Cell(116,7,iconv("UTF-8", "ISO-8859-1",date("y-m-d")." ".date("h:s A")),0,0,'L');
	...
	$pdf->Cell(90,7,iconv("UTF-8", "ISO-8859-1","N", ),'L',0,'C');
